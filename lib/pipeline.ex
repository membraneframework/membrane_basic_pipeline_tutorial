defmodule Basic.Pipeline do
  ...
  def handle_setup(_context, _state) do
    structure = [
      ...
      get_child(:depayloader1) |> via_in(Pad.ref(:input, :first)) |> get_child(:mixer),
      get_child(:depayloader2) |> via_in(Pad.ref(:input, :second)) |> get_child(:mixer),
      get_child(:depayloader3) |> via_in(Pad.ref(:input, :third)) |> get_child(:mixer)
    ]
